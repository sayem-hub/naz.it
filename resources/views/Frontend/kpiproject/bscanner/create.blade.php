...
<div class="row" style="color: rgb(71, 67, 67)">
    ...
    <div class="col-md-6">
        ...
        <form action="{{route('bscanner.create')}}" method="post">
          @csrf
           <div class="mb-3">
                <label for="bscan_id" class="form-label">Tab ID</label>
                <input type="text" class="form-control" name="bscan_id" id="bscan_id" value="NBSCN-">
            </div>
