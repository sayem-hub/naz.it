...
<form action="{{route('tablet.edit', $tablets->id)}}" method="post">
    @csrf
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <select class="form-control" name="brand">
            <option value="{{ $tablets->brand }}" selected>{{$tablets->brand}}</option>
...
<div class="mb-3">
    ...
    <select class="form-control" name="size">
        <option value="{{ $tablets->size }}" selected>{{ $tablets->size }}</option>
    ...
    <div class="mb-3">
        ...
        <select class="form-control" name="line_no">
            <option value="{{$tablets->line_no}}" selected>{{$tablets->line_no}}</option>
